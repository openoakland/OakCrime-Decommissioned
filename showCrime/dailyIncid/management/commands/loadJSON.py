        ...
        for iidx, incidInfo in enumerate(incidList):
            ...
            try:
                ...
                if xlng == '' or ylat == '':
                    ...
                    # NB: for consistency, newOC's (redundant) xlng, ylat derived from Point,
                    # not taken from xlng float string
            ...
            if verboseFreq is not None and (nadd % verboseFreq == 0):
                print(ncid, nadd, ncc, ngeo)
