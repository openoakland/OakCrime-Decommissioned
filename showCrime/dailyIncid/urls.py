...
urlpatterns = [
	# url(r'^$', TemplateView.as_view(template_name="dailyIncid/underMaint.html")),											   
	...
	url(r'ncpc/$', views.bldNCPCRpt, name='ncpc'),
	url(r'downloadNCPC/(?P<beat>[0-9XY+]+)_(?P<minDateDigit>[0-9]+)_(?P<maxDateDigit>[0-9]+)/$', views.downloadNCPC, name='downloadNCPC'),
